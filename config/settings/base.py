...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/mydjango")
}
...
LOCAL_APPS = [
    ...
    "mydjango.quora.apps.QuoraConfig",
...
EMAIL_TIMEOUT = 5
# EMAIL_USE_TSL = env("DJANGO_EMAIL_PORT", default=1025)
...
ADMINS = [("""wendell""", "wendell@wendell.vip")]
