# Generated by Django 3.0.11 on 2020-12-30 02:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('0', 'Open'), ('C', 'Close'), ('D', 'Draft')], default='0', max_length=1, verbose_name='问题状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answoers', to=settings.AUTH_USER_MODEL, verbose_name='回答者')),
            ],
            options={
                'verbose_name': '回答',
